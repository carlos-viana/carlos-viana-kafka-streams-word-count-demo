...
public class KafkaStreamsFavoriteColorApplication {
    private static final Logger logger = Logger.getLogger(KafaStreamsWordCountInputApplication.class.getName());

    private static final String TOPIC_INPUT = "favorite-color-input";
    private static final String TOPIC_OUTPUT = "favorite-color-output";
